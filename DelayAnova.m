...
allTRs= repmat(trials, [1, subjectCount])';
...
[p,tbl,stats] =anovan(reinstatementsVector', {subjects', allTRs'}, 'alpha', 1)
 multcompare(stats, 'Dimension', [2], 'alpha', 1)
...
[p,tbl,statsBins] =anovan(reinstatementBins', {subjectsBins', allTRsBins'}, 'alpha', .1)
 multcompare(statsBins, 'Dimension', [2], 'alpha', .1)
